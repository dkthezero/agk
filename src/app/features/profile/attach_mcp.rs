...
/// Attach an MCP server reference to a profile.
pub fn run(
...
mod tests {
    ...
    #[test]
    fn attach_mcp_to_existing_profile() {
    ...
    #[test]
    fn attach_duplicate_mcp_emits_error() {
        let mut config = ConfigFile::default();
        config.profiles.push(Profile {
            name: "test".to_string(),
            provider_id: "opencode".to_string(),
